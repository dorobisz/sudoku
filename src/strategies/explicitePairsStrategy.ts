...
export const detectPairs = (cells: Sudoku, value?: number): Array<StrategyCell> => {
...
const explicitePairsStrategy = (sudoku: Sudoku, cell: Cell): Strategy => {

    const pairsStrategy: StrategyFunction = (cells: Sudoku) => {
